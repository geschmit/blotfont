...
// esbuild --outfile=card.js --bundle examples/card.ts 
...
const CreateTube = (char: any, org: Point, scale: number): void => {
...
setDocDimensions(127, 76.2)

// decorations
const blotLogo = createTurtle()
...
blotLogo.translate([-203, -138])
drawTurtles([blotLogo])

// blot build number
DrawText("Build No. ", [3, 4], 0.82);
const tubeOrg = [52.15, 3.14];
...
// info card
DrawText("Blot", [12.22, 67.56], 0.89)
DrawText("Welcome to Blot", [5.63, 53.25], 1.59)
